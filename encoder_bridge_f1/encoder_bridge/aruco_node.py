...
class ArucoNode(Node):
    def __init__(self):
        ...
        self.declare_parameter('static_marker_ids', list(range(10, 69)))
        self.declare_parameter('target_marker_id', 98)
        self.declare_parameter('marker_size_m', 0.085)
        ...
        self.get_logger().info(
            'Aruco node started: static localization markers + target marker'
        )
